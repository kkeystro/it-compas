...
│   │   └── it-track.kkeystro.ru.conf
│   ├── Кейс3_Деплой.md
│   ├── Кейс3_Документация.md
│   ├── Кейс3_Карьерный_компас_бэкенд_план.md
│   ├── Кейс3_Карьерный_компас_фронтенд_план.md
│   ├── Кейс3_Улучшения.md
│   └── Финальный_проект_для_ИТ_траектории.docx
└── .gitignore
```
